...
class etho(): 
    data = json.load(open("E:/Ethonology/Etho.json","r",encoding="utf-8"))
    #@staticmethod
    def country_list():
         """
    ...
    def country_summary(country_name="India"):
        ...
        Examples
        --------        
        >>> etho.country_summary('Sri_Lanka')
        ...
        """
         return(etho.data[country_name]['summary'])
    ...
    def country_officialname(country_name="India"):
        ...
        Examples
        --------
        >>> etho.country_officialname('Thailand')
        'Kingdom of Thailand'

        >>> etho.country_officialname('Algeria')
        'Democratic and Popular Republic of Algeria'
        
        """
         return(etho.data[country_name]['official_name'])
    ...
    def country_code(country_name="IN"):
        ...
        Examples:
        --------
        >>> etho.country_code("Algeria")
        DZ

        >>> etho.country_code("Japan")
        JP
        """
         return(etho.data[country_name]['country_code(ISO3166)'])
    ...
    def country_area(country_name="India"):
        ...
        Examples:
        --------
        >>> etho.country_area("Bangladesh")
        '130170 Square Kilometer'

        >>> etho.country_area("Argentina")
        '2736690 Square Kilometer'
        """
         return(str(etho.data[country_name]['area(sq_km)'])+" Square Kilometer")
    ...
    def country_commencement(country_name="India"):
        ...
        Examples:
        --------
        >>> etho.country_commencement('Pakistan')
        1947

        >>> etho.country_commencement('Japan')
        1956

        >>> etho.country_commencement('Mexico')
        1945
        """
         return(etho.data[country_name]['commencement'])
    ...
    def country_continent(country_name="India"):
        ...
        Examples:
        --------
        >>>  etho.country_continent('Sri_Lanka')
        'Asia'

        >>> etho.country_continent('New_Zealand')
        'Australia'

        """
         return(etho.data[country_name]['continent'])

    def country_families(country_name):
         """
        ...
        >>> etho.country_families('Thailand')
        dict_keys(['Austro-Asiatic', 'Kra-Dai', 'Sino-Tibetan', 'Austronesian', 'Sign language', 'Hmong-Mien'])
        """

         return(etho.data[country_name]['families'].keys())
    
    """
    def country_family_languages(family_name, country_name):
        
        families = etho.data[country_name]['families']
    ...
    def continent_countries(continent="Asia"):
        ...
        Examples:
        --------
        >>> etho.continent_countries('Australia')
        ...
        >>>  etho.continent_countries('Africa')
        ...
        """
         conti=[]
         for i in etho.data.keys():
             if(etho.data[i]['continent'] == continent):
                 conti.append(i)
         return(conti)
    ...
    def total_countries():
        ...
        Examples:
        --------
        >>> etho.total_countries()
        195 

        """
         print(len(etho.data.keys()))
    ...
    def continent_length(continent="Asia"):
        ...
        Examples:
        --------
        >>> etho.continent_length("Africa")
        53

        >>> etho.continent_length("Australia")
        15
    ...
    def country_languages(country_name="India"):
        ...
        Examples:
        --------
        >>> etho.country_languages('Namibia')
        ...
        x = []
        for i in etho.data[country_name]['languages']:
            x.append(i)
        return x
    ...
    def language_summary( country_name="India", lang="Tamil"):
        ...
        Examples:
        --------
        >>> etho.language_summary('India','Tamil')
        ...
        >>> etho.language_summary('Namibia','Fwe')
        ...
        """
        return (etho.data[country_name]['languages'][lang]['summary'])
    ...
    def language_code(country_name="India", lang="Tamil"):
        ...
        Examples:
        --------
        >>> etho.language_code('India','Tamil')
        'tam'

        >>> etho.language_code('Argentina','Lule')
        'ule'
        """
        return (etho.data[country_name]['languages'][lang]['language_code(ISO639)'])
    ...
    def language_population(country_name="India", lang="Tamil"):
        ...
        Examples:
        --------
        >>> etho.language_population('India','Tamil')
        '1M to 1B'

        >>> etho.language_population('Mexico','Yaqui')
        '10K to 1M'
        """
        return (etho.data[country_name]['languages'][lang]['population'])
    ...
    def language_family(country_name="India", lang="Tamil"):
        ...
        Examples:
        --------
        >>> etho.language_family('India','Tamil')
        'It belongs to the Dravidian language family.'

        >>> etho.language_family('China','Zhaba')
        'It belongs to the Sino-Tibetan language family.'

        >>> etho.language_family('Mexico','Yaqui')
        'It belongs to the Uto-Aztecan language family.'
        """
        return (etho.data[country_name]['languages'][lang]['family'])
    ...
    def lang_to_country(lang="Tamil"):
        ...
        Examples:
        --------
        >>> etho.lang_to_country('Tamil')
        India
        Sri_Lanka

        >>> etho.lang_to_country('Spanish')
        Andorra
        Spain
        """
        ...
        for i in etho.data.keys():
            a=[]
            for j in etho.data[i]['languages'].keys():
                a.append(j)
            for k in a:
    ...
    def languagecode_to_country(code):
        ...
        Examples:
        --------
        >>> etho.languagecode_to_country('eng')
        Ireland
        United_Kingdom
        
        >>> etho.languagecode_to_country('spa')
        Andorra
        Spain
        """
        for i in etho.data.keys():
            for j in etho.data[i]["languages"]:
                a=[]
                a.append(etho.data[i]["languages"][j]["language_code(ISO639)"])
                for k in  a:
                    if (code == k):
                        print(i)
    
    def country_family_languages(country_name,family_name):
        """
        ...
        Examples:
        --------
        >>> etho.country_family_languages('Japan','Japonic')
        ...
        >>> etho.country_family_languages('India','Dravidian')
        ...
        b = []
        for i in etho.data[country_name]['families'][family_name]:
            modified_string = i[:-4] + " 'Language Code':" + i[-3:]
            b.append(modified_string)

        return b

    def language_to_family(language_name):
        """
        ...
        Examples:
        --------
        >>> etho.language_to_family('Tamil')
        'Dravidian'

        >>> etho.language_to_family('Japanese')
        'Japonic'

        >>> etho.language_to_family('English')
        'Creole'

        """
        a=[]
        for i in etho.data.keys():
            for j,k in etho.data[i]["families"].items():
                a.append(k)
    ...
    def all_families_list():
        ...
        a=[]
        for i in etho.data.keys():
            for j in etho.data[i]['families'].keys():
                a.append(j)
    ...
    def family_to_country(family_name):
        """
        ...
        Examples:
        --------
        >>> etho.family_to_country('Dravidian')
        Afghanistan
        Bangladesh
        India
        Nepal
        ...
        >>> etho.family_to_country('Japonic')
        Japan
        """
        for i in etho.data.keys():
            a=[]
    ...
    def all_family_languages(family):
            ...
            result = []
            for i in etho.data.keys():
                if family in etho.data[i]['families']:
                    result.append(etho.data[i]['families'][family])
            return result
